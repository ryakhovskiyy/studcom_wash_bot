...
MAIN_MENU_HIDDEN = "Главное меню скрыто..."

MAIN_MENU_USER_CHATING = "Используй, пожалуйста, кнопки:"

CHOOSE_PARAMETERS = "Выбери параметры для поиска слота:"

CANCEL_MESSAGE = "Действие отменено. Ты возвращен в главное меню:"

# --- Бронирование ---

BOOKING_ERROR = "Произошла ошибка при бронировании. Пожалуйста, перезапусти бота ('/start') и попробуй еще раз."

NOT_OK_STATUS = "Пожалуйста, заверши регистрацию, чтобы получить доступ к этой функции. Введи /start для перезапуска бота."

def get_text_after_booking_limit(limit: int) -> str:
    if limit == 1:
        return f"У тебя уже есть {limit} активная запись."
    return f"У тебя уже есть {limit} активных записей."